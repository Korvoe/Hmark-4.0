...
class CreateMongoBinTestsTable extends Migration
{
    /**
    ...
    public function up()
    {
        Schema::connection($this->connection)->create('mongo_bin_tests', function (Blueprint $collection) {
    ...
    {
        Schema::connection($this->connection)->drop('mongo_bin_tests');
    }
}
